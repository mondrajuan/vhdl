...
begin -- Inicio de la arquitectura
  ...
  -- Cada línea conecta un módulo externo a las señales internas de este top level
  ...
  -- Convierte el dato binario de la RAM en los 3 caracteres ASCII que formarán el número decimal
  -- Este proceso corre continuamente: no espera ningún estado en particular para actualizar los displays
