...
architecture pro of finalprimercorte2 is
    ...
    -- Se declaran los módulos que serán utilizados dentro del sistema

    component contadorvhl is -- Divisor de frecuencia
        port(
            clk      : in  std_logic; -- Reloj de entrada
            freq_sel : in  std_logic_vector(1 downto 0); -- Selector de frecuencia
            clk_out  : out std_logic -- Reloj dividido de salida
        );
    end component;

    component bcda7seg is -- Decodificador de BCD a display de 7 segmentos
        port(
            A : in  std_logic_vector(3 downto 0); -- Entrada en BCD
            D : out std_logic_vector(6 downto 0) -- Salida para el display
        );
    end component;

    component contador7seg is -- Contador que genera unidades, decenas y minutos
        port(
            clkE   : in std_logic; -- Reloj habilitado para el contador
            reset  : in std_logic; -- Señal de reinicio
            seguni : out std_logic_vector(3 downto 0); -- Valor BCD de unidades
            segdec : out std_logic_vector(3 downto 0); -- Valor BCD de decenas
            min    : out std_logic_vector(3 downto 0) -- Valor BCD de minutos
        );
    end component;
